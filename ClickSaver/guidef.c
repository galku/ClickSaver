            ...
            PUM_ADDCHILD,
                    PU_HORGROUP,
                        PUM_ADDCHILD, PU_LEFT_VERGROUP,
                            ...
                            PUM_ADDCHILD, PU_SPACER,
                            PUM_ADDCHILD, PU_LABEL( "PRK/AO install directory:" ),
                            PUM_ADDCHILD, PU_HORGROUP,
                                PUM_ADDCHILD, PU_ACTION_OBJDEF, CS_INSTALLDIR_ENTRY, ( PUU32 )"TextEntry",
                                    PUA_CONTROL_WEIGHT, 1,
                                    PUA_TEXTENTRY_BUFFERSIZE, 260,
                                    PUA_TEXTENTRY_BUFFER, ( PUU32 )"",
                                0, 0,
                                PUM_ADDCHILD, PU_ACTION_OBJDEF, CS_INSTALLDIR_BROWSE, ( PUU32 )"Text",
                                    PUA_TEXT_STRING, ( PUU32 )"Browse...",
                                    PUA_CONTROL_FRAME, PUFRAME_BUTTON,
                                    PUA_CONTROL_ISBUTTON, TRUE,
                                    PUM_ADDNOTIFICATION,
                                        PUNOTIFY_CONDITION_ATTREQUALS, PUA_CONTROL_CLICKED, TRUE,
                                        PUNOTIFY_ACTION_APPMSG, CSAM_BROWSE_INSTALLDIR,
                                    0,
                                0, 0,
                                PUM_ADDCHILD, PU_ACTION_OBJDEF, CS_INSTALLDIR_VALIDATE, ( PUU32 )"Text",
                                    PUA_TEXT_STRING, ( PUU32 )"Validate",
                                    PUA_CONTROL_FRAME, PUFRAME_BUTTON,
                                    PUA_CONTROL_ISBUTTON, TRUE,
                                    PUM_ADDNOTIFICATION,
                                        PUNOTIFY_CONDITION_ATTREQUALS, PUA_CONTROL_CLICKED, TRUE,
                                        PUNOTIFY_ACTION_APPMSG, CSAM_VALIDATE_INSTALLDIR,
                                    0,
                                0, 0,
                            PU_ENDGROUP,
